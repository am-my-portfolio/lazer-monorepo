<template>
  ...
  >
    <!-- Collapsed Sidebar -->
    <button type="button" class="-m-2.5 p-2.5 text-pop-secondary lg:hidden" @click="sidebarOpen = true">
      <span class="sr-only">Open sidebar</span>
      <i class="fa-solid fa-bars text-pop-secondary mt-1 text-2xl" aria-hidden="true"></i>
    </button>
    ...
    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
      ...
      <div class="flex items-center gap-x-4 lg:gap-x-6">
        <button type="button" class="-m-2.5 p-2.5 text-pop-secondary hover:text-secondary">
          <span class="sr-only">View notifications</span>
          <i
            class="fa-regular fa-bell fa-shake text-pop-secondary mt-1 text-xl"
            style="--fa-animation-delay: 10s; --fa-animation-duration: 3s; --fa-animation-iteration-count: 1"
            aria-hidden="true"
          ></i>
        </button>

        <!-- Separator large screen -->
        <div class="hidden lg:block lg:h-6 lg:w-px lg:bg-pop-secondary" aria-hidden="true" />
