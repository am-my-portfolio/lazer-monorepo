    ...
    <template #divisionContent>
      <div class="flex flex-col">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm md:max-w-full">
            ...
            <form class="space-y-6" @submit.prevent="handleSubmit">
              <div class="grid grid-cols-10 gap-6">
                <div id="config" class="col-span-10 md:col-span-5">
                  <fieldset class="border border-solid rounded-md text-pop-secondary border-pop-primary p-8 mt-10">
                    <legend class="p-2">Team's Details</legend>
                    <div class="grid gap-x-2 gap-y-6">
                      <div>
                        <label for="display_name" class="block text-sm font-medium leading-6 text-pop-secondary"
                          >Team Name</label
                        >
                        <div class="mt-2">
                          <input
                      ...
                      <div>
                        <div class="flex items-center justify-between">
                          <label for="logo_url" class="block text-sm font-medium leading-6 text-pop-secondary"
                            >Logo Url</label
                          >
                        </div>
                        <div class="mt-2">
                      ...
                      <div>
                        <div class="flex items-center justify-between">
                          <label for="team_size" class="block text-sm font-medium leading-6 text-pop-secondary"
                            >Team Size</label
                          >
                        </div>
                        <div class="mt-12">
                ...
                <div id="config" class="col-span-10 md:col-span-5">
                  <fieldset class="border border-solid rounded-md text-pop-secondary border-pop-primary p-8 mt-10">
                    ...
                    <div class="grid gap-x-2 gap-y-6">
                      <div>
                        <label for="email" class="block text-sm font-medium leading-6 text-pop-secondary"
                          >Email address</label
                        >
                        <div class="mt-2">
                          <input
          ...
          <div v-if="success" class="sm:mx-auto sm:w-full sm:max-w-sm md:max-w-2xl">
            <h3 class="mt-10 text-center text-xl font-bold leading-9 tracking-tight text-pop-primary">
              Successfully onboarded new Team
            </h3>
          </div>
        </div>
      </div>
...
const handleSubmit = async (event: SubmitEvent) => {
  ...
  success.value = await OrganizationRequests.orchestrateTenantOnboarding(team_details);
};
</script>
