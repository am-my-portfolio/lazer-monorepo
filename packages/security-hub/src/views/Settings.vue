<template>
  <PageLayout>
    ...
    <template #description> Fine-tune the settings of your app and team </template>
...
import { ref } from 'vue';
import { secondary_navigation } from '@/helpers';

import PageLayout from '@/components/layout/PageLayout.vue';
import Overview from '@/components/settings/Overview.vue';

const tabs = secondary_navigation.find((n) => n.name === 'Settings').items;
